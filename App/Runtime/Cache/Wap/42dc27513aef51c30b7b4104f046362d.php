        ...
        <div id="lists" v-if="Number(DB_CONFIG[DB].updown)">
            <div v-for="(v1,k1) in lists">
                <div v-for="(v2,k2) in v1" :class="'info-item ' + (k1%2?'bgc1':'bgc2')">
                    ...
                    <div class="flex-box">
                        <div>订单数：<span>{{v2.quantity}}</span></div>
                    ...
                    <div class="flex-box">
                        ...
                        <div>总长：<span>{{v2.total_len}}</span></div>
                    </div>
                    <div class="flex-box">
                    ...
                    <div class="flex-box">
                        <div>捆数：<span>{{v2.bundle_qty}}</span></div>
                    ...
                    <div class="flex-box">
                        <div>预计完成时间：<span>{{v2.pre_finishtime}}</span></div>
                    </div>
                    <div class="oblique-sign-up" v-if="v2.tag === '1'">上刀</div>
                    <div class="oblique-sign-down" v-if="v2.tag === '-1'">下刀</div>
                </div>
            </div>
        </div>
        <div id="lists" v-else>
            <div v-for="(v,k) in lists" :class="'info-item ' + (k%2?'bgc1':'bgc2')">
                ...
                <div class="flex-box">
                    <div>订单数：<span>{{v.quantity}}</span></div>
                ...
                <div class="flex-box">
                    ...
                    <div>总长：<span>{{v.total_len}}</span></div>
                </div>
                <div class="flex-box">
                ...
                <div class="flex-box">
                    <div>捆数：<span>{{v.bundle_qty}}</span></div>
                ...
                <div class="flex-box">
                    <div>预计完成时间：<span>{{v.pre_finishtime}}</span></div>
                </div>
            </div>
        </div>
    </div>
